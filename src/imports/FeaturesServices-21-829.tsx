...
function Frame9() {
  return (
    <div className="h-[230px] relative rounded-tl-[8px] rounded-tr-[8px] shrink-0 w-[370px]">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-tl-[8px] rounded-tr-[8px] size-full" src={imgFrame1000005037} />
    </div>
  );
}
