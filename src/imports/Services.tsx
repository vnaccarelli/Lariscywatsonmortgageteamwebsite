...
function Frame() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-center relative shrink-0">
      <p className="font-['Poppins:Bold',sans-serif] leading-[48px] not-italic relative shrink-0 text-[#1e1e1e] text-[40px] text-center text-nowrap whitespace-pre">Services</p>
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="h-[230px] overflow-clip relative rounded-[8px] shrink-0 w-[370px]">
      <div className="absolute h-[303px] left-[calc(50%-0.48px)] top-0 translate-x-[-50%] w-[452.256px]" data-name="Happy lady in office yellow jacket 1">
...
function Frame11() {
  return (
    <div className="bg-[#272c3a] h-[230px] overflow-clip relative rounded-[8px] shrink-0 w-[370px]">
...
function Frame1() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[60px] items-center px-0 py-[120px] relative shrink-0 w-full">
      <SectionTitle />
      <Frame8 />
    </div>
  );
  ...
  return (
    <div className="bg-white relative size-full" data-name="Services">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] items-start px-[135px] py-[20px] relative size-full">
          <Frame1 />
        </div>
      </div>
    </div>
